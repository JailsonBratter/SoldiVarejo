...
if not exists(select 1 from PARAMETROS where PARAMETRO='N_IMP_REF_PED')
begin	
INSERT INTO [PARAMETROS]
     ...
     VALUES
           ...
           ,GETDATE()
           ,'FALSE'
           ,'NAO IMPRIME REF DE PRODUTO NO PEDIDO'
           ,''
           ,0
           ,1
           ,''
...
insert into Versoes_Atualizadas select 'Versão:1.222.719', getdate();
GO
