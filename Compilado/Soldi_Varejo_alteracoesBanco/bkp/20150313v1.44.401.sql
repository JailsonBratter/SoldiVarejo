...
GO
/****** Object:  StoredProcedure [dbo].[sp_br_Mercadoria_Acum_Dia]    Script
Date: 03/13/2015 10:59:33 ******/
SET ANSI_NULLS OFF
GO
...
alter table mercadoria alter column descricao varchar(60) ;
alter table mercadoria alter column descricao_resumida varchar(40);
