...
if not exists(select 1 from PARAMETROS where PARAMETRO='ATIVA_ECOMMERCE')
begin	
INSERT INTO [PARAMETROS]
     ...
     VALUES
           ...
           ,GETDATE()
           ,'FALSE'
           ,'ATIVA INTEGRAÇAO COM E-COMMERCE'
           ,''
           ,0
           ,1
           ,''
...
/****** Object:  StoredProcedure [dbo].[sp_Rel_Resumo_Vendas]    Script Date: 11/01/2017 10:42:36 ******/
...
insert into Versoes_Atualizadas select 'Versão:1.188.638', getdate();
GO
