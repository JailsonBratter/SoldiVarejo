...
/****** Object:  StoredProcedure [dbo].[sp_Movimento_Venda]    Script Date: 09/26/2017 14:49:53 ******/
            ...
            IF(@finalizadora ='TODOS')
                  ...
                  BEGIN
                        ...
                        SELECT
							...
							INNER JOIN  Saida_estoque S  with (index(IX_Movimento_venda_01))  ON S.Documento=lista.Documento 
										and s.Caixa_Saida = lista.pdv	and s.Data_movimento = lista.Emissao
