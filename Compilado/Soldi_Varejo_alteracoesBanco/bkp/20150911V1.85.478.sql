...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Busca_Preco]') AND type in (N'U'))
DROP TABLE [dbo].[Busca_Preco]
GO
/****** Object:  Table [dbo].[Busca_Preco]    Script Date: 09/11/2015 11:22:35 ******/
