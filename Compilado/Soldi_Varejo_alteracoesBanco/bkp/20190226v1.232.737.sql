IF EXISTS( SELECT * FROM INFORMATION_SCHEMA.COLUMNS 
            ...
            AND  UPPER(COLUMN_NAME) = UPPER('frete'))
begin
	alter table pedido alter column frete numeric(18,2)
end
else
begin
	alter table pedido add frete numeric(18,2)
end 
go 
...
go
insert into Versoes_Atualizadas select 'Versão:1.232.737', getdate();
GO
