...
{
    public partial class Mobile_Venda_Departamento : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.Params["Codigo_SubGrupo"] != null)
            {
                if (!IsPostBack)
                {
                    ...
                    String strFilial = "";
                    String strSubGrupo = Request.Params["codigo_Grupo"];
                    lblFilial.Text = (String)Session["strFilialParSub"];
                    strFilial = lblFilial.Text;
                    lblData.Text = DateTime.Today.ToString("dd/MMM/yyy") + " | Vendas DEPARTAMENTO";
                    DataTable tb;
                    String sqlGrid = "sp_Rel_Venda_Departamento '" + strFilial + "', '" + DateTime.Today.ToString("yyyyMMdd") + "', '" + DateTime.Today.ToString("yyyyMMdd") + "', '" + strSubGrupo + "'";
