<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mobile_Venda_Departamento.aspx.cs" Inherits="visualSysWeb.modulos.mobile.pages.Mobile_Venda_Departamento" %>
...
<body>
    ...
    <div>
        <asp:GridView ID="gridPesquisa" runat="server" AutoGenerateColumns="False" AllowPaging="True"
            PageSize="50" CellPadding="10" ForeColor="#333333" GridLines="Vertical" 
            onrowdatabound="gridPesquisa_RowDataBound">
            <AlternatingRowStyle BackColor="#BEBEBE" ForeColor="#284775" />
            <Columns>
                <asp:HyperLinkField DataTextField="Codigo_Departamento" HeaderText="Codigo" Text="Codigo" />
                <asp:HyperLinkField DataTextField="Descricao_Departamento" HeaderText="Descricao" Text="Descricao" />
