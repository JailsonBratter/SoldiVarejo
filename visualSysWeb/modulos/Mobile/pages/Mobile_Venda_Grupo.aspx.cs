...
{
    public partial class Mobile_Venda_Grupo : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.Params["Filial"] != null & Request.Params["Filial"] != "TOTAL ....>>")
            {
                if (!IsPostBack)
                {
                    ...
                    String strFilial = Request.Params["Filial"];
                    lblFilial.Text = strFilial;
                    Session.Remove("strFilialPar");
                    Session.Add("strFilialPar", strFilial);
                    lblData.Text = DateTime.Today.ToString("dd/MMM/yyy") + " | Vendas GRUPO";
                    DataTable tb;
                    String sqlGrid = "sp_Rel_Venda_Grupo '" + strFilial + "', '" + DateTime.Today.ToString("yyyyMMdd") + "', '" + DateTime.Today.ToString("yyyyMMdd") + "'";
