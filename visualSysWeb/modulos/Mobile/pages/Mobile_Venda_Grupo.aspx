<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mobile_Venda_Grupo.aspx.cs"
    Inherits="visualSysWeb.modulos.mobile.pages.Mobile_Venda_Grupo" %>
...
<body>
    ...
    <div>
        <asp:GridView ID="gridPesquisa" runat="server" AutoGenerateColumns="False" AllowPaging="True"
            ...
            <Columns>
                <asp:HyperLinkField DataTextField="Codigo_Grupo" HeaderText="Grupo" Text="Grupo" DataNavigateUrlFormatString="~/modulos/mobile/pages/Mobile_Venda_SubGrupo.aspx?Codigo_Grupo={0}"
                    DataNavigateUrlFields="Codigo_Grupo" />
                <asp:HyperLinkField DataTextField="Descricao_Grupo" HeaderText="Descricao" Text="Descricao" DataNavigateUrlFormatString="~/modulos/mobile/pages/Mobile_Venda_SubGrupo.aspx?Codigo_Grupo={0}"
                    DataNavigateUrlFields="Codigo_Grupo" />
