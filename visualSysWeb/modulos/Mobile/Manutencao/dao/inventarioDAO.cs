...
namespace visualSysWeb.dao
{
    public class inventarioDAO
    {
        ...
        public String Descricao_inventario { get; set; }
        ...
        {
            String sqlItens = " Select * from inventario_itens where codigo_inventario='" + Codigo_inventario.Trim() + "' ";
            ...
            while (rsItens.Read())
            {
                ...
                item.Contada = rsItens["contada"].ToString().Equals("") ? 0 : Decimal.Parse(rsItens["contada"].ToString());
