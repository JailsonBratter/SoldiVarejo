<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="OutrasMovimentacoes.aspx.cs" Inherits="visualSysWeb.modulos.Manutencao.pages.OutrasMovimentacoes" %>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <p>
                        De</p>
                    <asp:TextBox ID="txtDataDe" runat="server" Width="80px"> </asp:TextBox>
        ...
        <asp:GridView ID="gridPesquisa" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                <asp:HyperLinkField DataTextField="Codigo_inventario" Text="---" Visible="true" HeaderText="Codigo"
                    DataNavigateUrlFormatString="~/modulos/Manutencao/pages/OutrasMovimentacoesDetalhes.aspx?campoIndex={0}"
                    DataNavigateUrlFields="codigo_inventario" />
                <asp:HyperLinkField DataTextField="TipoMovimentacao" Text="---" Visible="true"
                    HeaderText="Tipo" DataNavigateUrlFormatString="~/modulos/Manutencao/pages/OutrasMovimentacoesDetalhes.aspx?campoIndex={0}"
                    DataNavigateUrlFields="codigo_inventario" />
                
                <asp:HyperLinkField DataTextField="Descricao_inventario" Text="---" Visible="true"
                    HeaderText="Descricao" DataNavigateUrlFormatString="~/modulos/Manutencao/pages/OutrasMovimentacoesDetalhes.aspx?campoIndex={0}"
                    DataNavigateUrlFields="codigo_inventario" />
