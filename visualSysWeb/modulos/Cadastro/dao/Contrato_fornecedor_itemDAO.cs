...
{
    public class Contrato_fornecedor_itemDAO
    {
        public String id_contrato = "";
        public String plu = "";
        public String descricao = "";
        public Decimal vlr = 0;
        public String und = "";
        
        public Contrato_fornecedor_itemDAO() { }
        public Contrato_fornecedor_itemDAO(String campoIndex, User usr)
        { //colocar campo index da tabela
            String sql = "Select * from  Contrato_fornecedor_item where campoIndex =" + campoIndex;
        ...
        public void carregarDados(SqlDataReader rs)
        {
            if (rs.Read())
            {
                ...
                plu = rs["plu"].ToString();
                vlr = (Decimal)(rs["vlr"].ToString().Equals("") ? new Decimal() : rs["vlr"]);
                und = rs["und"].ToString();
            }
        ...
        private void update(SqlConnection conn, SqlTransaction tran)
        {
            try
            {
                String sql = "update  Contrato_fornecedor_item set " +

                              "plu='" + plu + "'" +
                              ",vlr=" + vlr.ToString().Replace(",", ".") +
                              ",und ='"+und+"'"+
        ...
        public bool excluir()
        {
            String sql = "delete from Contrato_fornecedor_item  where id_contrato='" + id_contrato + "'";
        ...
        private void insert(SqlConnection conn, SqlTransaction tran)
        {
            try
            {
                String sql = " insert into Contrato_fornecedor_item (" +
                          "id_contrato" +
                          ",plu" +
                          ",vlr" +
                          ",und"+
                     " )values( " +
                          "'" + id_contrato + "'" +
                          "," + "'" + plu + "'" +
                          "," + Funcoes.decimalPonto(vlr.ToString()) +
                          ",'"+und+"'"+
                         ");";
...
{ 
                  static DataTable tb;
                  static String sqlGrid = ""select * from Contrato_fornecedor_item";//colocar os campos no select que ser?o apresentados na tela
                  ...
                  {
                      Response.Redirect("~/modulos/nome Do Modulo/pages/ Contrato_fornecedor_itemDetalhes.aspx?novo=true"); // colocar caminho da pagina de Detalhes verificar Case sensitive
                  }
...
/*================================html tela de Pesquisa==========================================
   ...
   <center><h1>Contrato_fornecedor_item</h1></center>
    <hr />              
        ...
        <div class="gridTable">          
            <asp:GridView ID="gridPesquisa" runat="server" AutoGenerateColumns="False"           
                 ...
                 <Columns> 
                    ...
                    HeaderText="id_contrato" DataNavigateUrlFormatString="~/modulos/Coloca Nome Do Modulo/Contrato_fornecedor_itemDetalhes.aspx?campoIndex={0}" 
                    ...
                    HeaderText="plu" DataNavigateUrlFormatString="~/modulos/Coloca Nome Do Modulo/Contrato_fornecedor_itemDetalhes.aspx?campoIndex={0}" 
                        DataNavigateUrlFields="//colocar o campo Index que fara a pesquisar" />  

                    <asp:HyperLinkField DataTextField="vlr" Text="vlr" Visible="true" 
                    HeaderText="vlr" DataNavigateUrlFormatString="~/modulos/Coloca Nome Do Modulo/Contrato_fornecedor_itemDetalhes.aspx?campoIndex={0}" 
                        DataNavigateUrlFields="//colocar o campo Index que fara a pesquisar" />  
...
using System.Data.SqlClient;
  ...
  {
                 protected static Contrato_fornecedor_itemDAO obj= null ;
                 static String camporeceber = "";
                 protected void Page_Load(object sender, EventArgs e)     
                 {
                      User usr = (User)Session["User"];
                      obj = new Contrato_fornecedor_itemDAO();
                           ...
                           if (Request.Params["campoIndex"] != null)  // colocar o campo index da tabela
                           {
                              try
                              {
                                   if (!IsPostBack)
                                   {
                                        ...
                                        status = "visualizar";
                                        obj = new Contrato_fornecedor_itemDAO(index,usr);
                                        carregarDados();
                                    }
      ...
      private void carregarDados()
      {
                                         ...
                                         txtvlr.Text=obj.vlr.ToString("N2");
   }
     ...
     private void carregarDadosObj()
     {
                                         ...
                                         obj.plu=txtplu.Text;
                                         Decimal.TryParce(txtvlr.Text , out obj.vlr);
   }
...
<div class="cabMenu">                  
       <center> <h1>Detalhes do Contrato_fornecedor_item</h1></center>                  
</div>                  
    <asp:Panel ID="pnBtn" runat="server" CssClass="cabMenu">                  
    </asp:Panel>                  
    <br />              
...
/*--Campos Form
                   ...
                   <asp:TextBox ID="txtplu" runat="server" ></asp:TextBox>
                                      ...
                                      <td >                   <p>vlr</p>
                   <asp:TextBox ID="txtvlr" runat="server" CssClass="numero" ></asp:TextBox>
                   </td>
