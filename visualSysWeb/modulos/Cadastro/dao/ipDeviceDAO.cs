...
{
    public class ipDeviceDAO
    {
        public String filial { get; set; }
        public String ip { get; set; }
        public String tipo { get; set; }
        public String balanca_serial { get; set; }
        public int id { get; set; }
        public ipDeviceDAO(User usr) {
            filial = usr.getFilial();
        }
        public ipDeviceDAO(String id, User usr)
        { //colocar campo index da tabela
            filial = usr.getFilial();
            String sql = "Select * from  ipDevice where id =" + id;
        ...
        public void carregarDados(SqlDataReader rs)
        {
            if (rs.Read())
            {
                ...
                balanca_serial = rs["balanca_serial"].ToString();
        ...
        private void update()
        {
            try
            {
                String sql = "update  ipDevice set " +
                              "filial='" + filial + "'" +
                              ",ip='" + ip + "'" +
                              ",tipo='" + tipo + "'" +
                              ",balanca_serial=" + balanca_serial.ToString()+
        ...
        public bool excluir()
        {
            String sql = "delete from ipDevice  where id= " + id;
            Conexao.executarSql(sql);
            return true;
        }
        ...
        private void insert()
        {
            try
            {
                String sql = " insert into ipDevice (" +
                          "filial," +
                          "ip," +
                          "tipo," +
                          "balanca_serial," +
...
{ 
                  ...
                  {
                      Response.Redirect("~/modulos/nome Do Modulo/pages/ ipDeviceDetalhes.aspx?novo=true"); // colocar caminho da pagina de Detalhes verificar Case sensitive
                  }
        ...
        <div class="gridTable">          
            <asp:GridView ID="gridPesquisa" runat="server" AutoGenerateColumns="False"           
                 ...
                 <Columns> 
                    ...
                    HeaderText="filial" DataNavigateUrlFormatString="~/modulos/Coloca Nome Do Modulo/ipDeviceDetalhes.aspx?campoIndex={0}" 
                        DataNavigateUrlFields="//colocar o campo Index que fara a pesquisar" />  

                    <asp:HyperLinkField DataTextField="ip" Text="ip" Visible="true" 
                    HeaderText="ip" DataNavigateUrlFormatString="~/modulos/Coloca Nome Do Modulo/ipDeviceDetalhes.aspx?campoIndex={0}" 
                        DataNavigateUrlFields="//colocar o campo Index que fara a pesquisar" />  

                    <asp:HyperLinkField DataTextField="tipo" Text="tipo" Visible="true" 
                    HeaderText="tipo" DataNavigateUrlFormatString="~/modulos/Coloca Nome Do Modulo/ipDeviceDetalhes.aspx?campoIndex={0}" 
                        DataNavigateUrlFields="//colocar o campo Index que fara a pesquisar" />  

                    <asp:HyperLinkField DataTextField="balanca_serial" Text="balanca_serial" Visible="true" 
                    HeaderText="balanca_serial" DataNavigateUrlFormatString="~/modulos/Coloca Nome Do Modulo/ipDeviceDetalhes.aspx?campoIndex={0}" 
                        DataNavigateUrlFields="//colocar o campo Index que fara a pesquisar" />  

                    <asp:HyperLinkField DataTextField="id" Text="id" Visible="true" 
                    HeaderText="id" DataNavigateUrlFormatString="~/modulos/Coloca Nome Do Modulo/ipDeviceDetalhes.aspx?campoIndex={0}" 
                        DataNavigateUrlFields="//colocar o campo Index que fara a pesquisar" />  
...
using System.Data.SqlClient;
  ...
  {
                 protected static ipDeviceDAO obj= null ;
      ...
      private void carregarDados()
      {
                                         ...
                                         chkbalanca_serial.Checked =obj.balanca_serial;
     ...
     private void carregarDadosObj()
     {
                                         ...
                                         obj.balanca_serial=chkbalanca_serial.Checked ;
...
/*--Campos Form
                   ...
                   <asp:TextBox ID="txttipo" runat="server" ></asp:TextBox>
                                      ...
                                      <td >                   <p>balanca_serial</p>
                   <td><asp:CheckBox ID="chkbalanca_serial" runat="server" Text="balanca_serial"/>
                   </td>
