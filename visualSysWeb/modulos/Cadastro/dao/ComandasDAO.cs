...
namespace visualSysWeb.dao
{
    public class ComandaDAO
    {
        ...
        public ComandaDAO() { }
        public ComandaDAO(String campoIndex, User usr)
        { //colocar campo index da tabela
            String sql = "Select * from  Comanda_Controle where Comanda =" + campoIndex;
        ...
        public void carregarDados(SqlDataReader rs)
        {
            if (rs.Read())
            {
                String comanda = rs["Comanda"].ToString();
                Comanda = (comanda.ToString().Equals("") ? new Decimal() : Decimal.Parse(comanda));
                Observacao = rs["OBS"].ToString();
                Status = int.Parse(rs["Status"].ToString());
            }
        ...
        private void update()
        {
            try
            {
                String sql = "UPDATE  Comanda_Controle SET " +
                              "OBS ='" + Observacao + "'" +
        ...
        public bool excluir(String status)
        {
            
            String sql = "update comanda_controle set status ='" +status+ "' WHERE Comanda= " + Comanda; //colocar campo index
        ...
        private void insert()
        {
            try
            {
                String sql = " insert into Comanda_Controle (" +
                          "Comanda," +
                          "Obs," +
                          "Status)" +
                     " values (" +
                          Comanda.ToString().Replace(",", ".") +
                          "," + "'" + Observacao + "'" +
