...
{
    public class Cliente_Pet_VacinaDAO
    {
        public String Nome_Pet = "";
        public String Codigo_Cliente = "";
        public String Vacina = "";
        public DateTime Data_ultima_vacinacao = new DateTime();
        public String Data_ultima_vacinacaoBr()
        {
            return dataBr(Data_ultima_vacinacao);
        }

        public String codigo_pet = "";


        public Cliente_Pet_VacinaDAO() { }
        public Cliente_Pet_VacinaDAO(String codigo_pet,String codigo_cliente, User usr)
        { //colocar campo index da tabela
            String sql = "Select * from  Cliente_Pet_Vacina where codigo_pet =" + codigo_pet +" and codigo_cliente='"+codigo_cliente;
        ...
        public void carregarDados(SqlDataReader rs)
        {
            if (rs.Read())
            {
                ...
                Vacina = rs["Vacina"].ToString();
                Data_ultima_vacinacao = (rs["Data_ultima_vacinacao"].ToString().Equals("") ? new DateTime() : DateTime.Parse(rs["Data_ultima_vacinacao"].ToString()));
        ...
        private void update(SqlConnection conn, SqlTransaction tran)
        {
            try
            {
                String sql = "update  Cliente_Pet_Vacina set " +
                              "Nome_Pet='" + Nome_Pet + "'" +
                              ",Codigo_Cliente='" + Codigo_Cliente + "'" +
                              ",Vacina='" + Vacina + "'" +
                              ",Data_ultima_vacinacao=" + (Data_ultima_vacinacao.ToString("yyyy-MM-dd").Equals("0001-01-01") ? "null" : "'" + Data_ultima_vacinacao.ToString("yyyy-MM-dd") + "'") + "," +
                              ",codigo_pet='" + codigo_pet + "'" +
                    "  where = " //ARRUMAR CAMPO INDEX
                        ;
        ...
        public bool excluir()
        {
            String sql = "delete from Cliente_Pet_Vacina  where campoIndex= "; // +campoIndex; //colocar campo index
        ...
        public ArrayList ArrToString()
        {
            ...
            item.Add(Vacina.ToString());
            item.Add(Data_ultima_vacinacaoBr());
        ...
        private void insert(SqlConnection conn, SqlTransaction tran)
        {
            try
            {
                String sql = " insert into Cliente_Pet_Vacina (" +
                          "Nome_Pet," +
                          "Codigo_Cliente," +
                          "Vacina," +
                     ...
                     ") values (" +
                          ...
                          "," + "'" + Codigo_Cliente + "'" +
                          "," + "'" + Vacina + "'" +
                          "," + (Data_ultima_vacinacao.ToString("yyyy-MM-dd").Equals("0001-01-01") ? "null" : "'" + Data_ultima_vacinacao.ToString("yyyy-MM-dd") + "'") +
                          "," + "'" + codigo_pet + "'" +
                         ");";
...
{ 
                  static DataTable tb;
                  static String sqlGrid = ""select * from Cliente_Pet_Vacina";//colocar os campos no select que ser?o apresentados na tela
                  ...
                  {
                      Response.Redirect("~/modulos/nome Do Modulo/pages/ Cliente_Pet_VacinaDetalhes.aspx?novo=true"); // colocar caminho da pagina de Detalhes verificar Case sensitive
                  }
...
/*================================html tela de Pesquisa==========================================
   ...
   <center><h1>Cliente_Pet_Vacina</h1></center>
    <hr />              
        ...
        <div class="gridTable">          
            <asp:GridView ID="gridPesquisa" runat="server" AutoGenerateColumns="False"           
                 ...
                 <Columns> 
                    ...
                    HeaderText="Nome_Pet" DataNavigateUrlFormatString="~/modulos/Coloca Nome Do Modulo/Cliente_Pet_VacinaDetalhes.aspx?campoIndex={0}" 
                    ...
                    HeaderText="Codigo_Cliente" DataNavigateUrlFormatString="~/modulos/Coloca Nome Do Modulo/Cliente_Pet_VacinaDetalhes.aspx?campoIndex={0}" 
                        DataNavigateUrlFields="//colocar o campo Index que fara a pesquisar" />  

                    <asp:HyperLinkField DataTextField="Vacina" Text="Vacina" Visible="true" 
                    HeaderText="Vacina" DataNavigateUrlFormatString="~/modulos/Coloca Nome Do Modulo/Cliente_Pet_VacinaDetalhes.aspx?campoIndex={0}" 
                        DataNavigateUrlFields="//colocar o campo Index que fara a pesquisar" />  

                    <asp:HyperLinkField DataTextField="Data_ultima_vacinacao" Text="Data_ultima_vacinacao" Visible="true" 
                    HeaderText="Data_ultima_vacinacao" DataNavigateUrlFormatString="~/modulos/Coloca Nome Do Modulo/Cliente_Pet_VacinaDetalhes.aspx?campoIndex={0}" 
                        DataNavigateUrlFields="//colocar o campo Index que fara a pesquisar" />  

                    <asp:HyperLinkField DataTextField="codigo_pet" Text="codigo_pet" Visible="true" 
                    HeaderText="codigo_pet" DataNavigateUrlFormatString="~/modulos/Coloca Nome Do Modulo/Cliente_Pet_VacinaDetalhes.aspx?campoIndex={0}" 
                        DataNavigateUrlFields="//colocar o campo Index que fara a pesquisar" />  
...
using System.Data.SqlClient;
  ...
  {
                 protected static Cliente_Pet_VacinaDAO obj= null ;
                 static String camporeceber = "";
                 protected void Page_Load(object sender, EventArgs e)     
                 {
                      User usr = (User)Session["User"];
                      obj = new Cliente_Pet_VacinaDAO();
                           ...
                           if (Request.Params["campoIndex"] != null)  // colocar o campo index da tabela
                           {
                              try
                              {
                                   if (!IsPostBack)
                                   {
                                        ...
                                        status = "visualizar";
                                        obj = new Cliente_Pet_VacinaDAO(index,usr);
                                        carregarDados();
                                    }
      ...
      private void carregarDados()
      {
                                         ...
                                         txtVacina.Text=obj.Vacina.ToString();
                                         txtData_ultima_vacinacao.Text=obj.Data_ultima_vacinacaoBr();
     ...
     private void carregarDadosObj()
     {
                                         ...
                                         obj.Vacina=txtVacina.Text;
                                         obj.Data_ultima_vacinacao=(txtData_ultima_vacinacao.Text.Equals("")?new DateTime():DateTime.Parse(txtData_ultima_vacinacao.Text));
...
<div class="cabMenu">                  
       <center> <h1>Detalhes do Cliente_Pet_Vacina</h1></center>                  
</div>                  
    <asp:Panel ID="pnBtn" runat="server" CssClass="cabMenu">                  
    </asp:Panel>                  
    <br />              
...
/*--Campos Form
                   ...
                   <asp:TextBox ID="txtCodigo_Cliente" runat="server" ></asp:TextBox>
                                      ...
                                      <td >                   <p>Vacina</p>
                   <asp:TextBox ID="txtVacina" runat="server" ></asp:TextBox>
                   </td>

                                      <td >                   <p>Data_ultima_vacinacao</p>
                   <asp:TextBox ID="txtData_ultima_vacinacao" runat="server" ></asp:TextBox>
                   </td>
