<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProgramacaoPrecificacaoProdutosDetalhes.aspx.cs" Inherits="visualSysWeb.modulos.Gerencial.pages.ProgramacaoPrecificacaoProdutosDetalhes" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script src="../js/ProgramacaoPrecificacaoProdutosDetalhes.js"></script>
    <link href="../css/ProgramacaoPrecificacaoProdutosDetalhes.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="cabMenu">
        <center>
            <h1>
                PROGRAMAÇÃO DE PREÇOS </h1>
        </center>
    </div>
                ...
                <tr>
                    <td>
                        ...
                        <div class="panelItem">
                            ...
                            <asp:TextBox ID="txtDataCadastro" runat="server" Width="80px" CssClass="DATA"> </asp:TextBox>
                        </div>
                        <div class="panelItem">
                            <p>
                                Data Inicio
                            </p>
                            <asp:TextBox ID="txtDataInicio" runat="server" Width="80px" CssClass="DATA"> </asp:TextBox>
                            <asp:ImageButton ID="ImgDtInicio" ImageUrl="~/img/calendar.png" runat="server" Height="15px" />
                            <asp:CalendarExtender ID="clnDataAte" runat="server" PopupButtonID="ImgDtInicio" TargetControlID="txtDataInicio">
                    ...
                    <ContentTemplate>
                        ...
                        <div class="gridTable">
                            <asp:GridView ID="gridItens" runat="server" ForeColor="#333333" GridLines="Vertical"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="Ordem" HeaderText="Ordem" Visible="false"></asp:BoundField>
                                    ...
                                    <asp:TemplateField HeaderText="Preço" ItemStyle-Width="80px">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtPreco" runat="server" Text='<%# Eval("preco") %>' Width="90%" OnKeyPress="javascript:return autoTab(this,event);"
