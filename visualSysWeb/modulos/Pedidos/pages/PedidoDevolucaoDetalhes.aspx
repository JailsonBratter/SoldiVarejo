<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="PedidoDevolucaoDetalhes.aspx.cs" Inherits="visualSysWeb.modulos.Pedidos.pages.PedidoDevolucaoDetalhes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="cabMenu">
        <center>
            <h1>
                Detalhes do pedido de devolução Cliente</h1>
        </center>
    </div>
    ...
    <div id="cabecalho" runat="server" class="frame">
        <div class="btnImprimirDireita">
            <div class="panelItem">
                <asp:ImageButton ID="btnImprimirDevolucao" runat="server" ImageUrl="~/img/icon_imprimir.gif"
                    Height="40px" Visible="false" OnClick="btnImprimirDevolucao_Click" />
            </div>
        </div>
        <table>
            <%-- <tr>
            ...
            <tr>
                ...
                <td>
                    <p>
                        Data entrega</p>
                    <asp:TextBox ID="txtData_entrega" runat="server" Width="80px"></asp:TextBox>
            ...
            <tr>
                <td colspan="5">
                    ...
                    <asp:TextBox ID="txtCliente_Fornec" runat="server" Width="80px" OnTextChanged="txtCliente_Fornec_TextChanged"
                        CssClass="INTEIRO" AutoPostBack="true"></asp:TextBox>
                    <asp:TextBox ID="txtNomeCliente" runat="server" Width="400px" AutoPostBack="true"
                        OnTextChanged=" txtNomeCliente_TextChanged"></asp:TextBox>
                    <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" Enabled="true"
                        TargetControlID="txtNomeCliente" ServiceMethod="GetNomesClientes" ServicePath="PedidoDevolucaoDetalhes.aspx"
                ...
                <td>
                    <p>
                        Total Itens</p>
                    <asp:TextBox ID="txtTotalBruto" runat="server" Width="100px"></asp:TextBox>
                </td>
                <td>
                    <p>
                        Total</p>
    ...
    <asp:Panel ID="pnItens" runat="server" CssClass="modalForm" Style="display: none;
        ...
        <asp:Panel ID="pnItensFrame" runat="server" CssClass="frame">
            ...
            <div id="conteudoItem" runat="server">
                <table>
                    <tr>
                        <td>
                            <p>
                        ...
                        <td>
                            ...
                            <asp:TextBox ID="txtDescontoItem" runat="server" CssClass="numero" Width="100px"
                                OnChange="javascript:calculaTotal();"></asp:TextBox>
                        </td>
                        <td>
                            <p>
                                Preço</p>
    ...
    <asp:Panel ID="pnMercadoriaLista" runat="server" CssClass="modalForm" Style="display: none;
        ...
        <asp:Panel ID="pnMercadoriaListaFrame" runat="server" CssClass="frameDiv" DefaultButton="imgPesquisaMercadoria"
            ...
            <div class="row" style="font-size: 20px; width: 70%; float: left; margin-left: 20px;">
                Cupom:
                <asp:TextBox ID="txtCupom" runat="server" Width="80px"></asp:TextBox>
                PDV:
                <asp:TextBox ID="txtPdv" runat="server" Width="80px"></asp:TextBox>
                Data:
                <asp:TextBox ID="txtDataCupom" runat="server" CssClass="DATA" Width="80px"></asp:TextBox>
                <asp:Image ID="imgDtCupom" ImageUrl="~/img/calendar.png" runat="server" Height="15px" />
                <asp:CalendarExtender ID="CalendarExtender4" runat="server" PopupButtonID="imgDtCupom"
                    TargetControlID="txtDataCupom">
                </asp:CalendarExtender>
                <asp:ImageButton ID="imgPesquisaMercadoria" runat="server" ImageUrl="~/img/pesquisaM.png"
                    Height="30px" OnClick="ImgPesquisaMercadoria_Click" />
                Filtrar
            </div>
            <div class="row" style="font-size: 20px; width: 70%; float: left; margin-left: 20px;">
                Descrição:
                <asp:TextBox ID="txtDescricaoMercadoriaCupom" runat="server" Width="400px"></asp:TextBox>
            </div>
            <div class="panel" style="font-size: 20px; width: 20%; float: left; margin-top: -20px;">
                <div class="row" style="margin-top: 0; margin-bottom: 10px;">
                ...
                <asp:GridView ID="GridMercadoriaSelecionado" runat="server" CellPadding="4" ForeColor="#333333"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Qtd">
                            <ItemTemplate>
                                <asp:TextBox ID="txtQtd" runat="server" Text='<%# Eval("QTD") %>' Width="50px"></asp:TextBox>
                                <asp:Label ID="lblQTDPadrao" runat="server" Text='<%# Eval("QTDPadrao") %>' Visible="false"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
    ...
    <asp:Panel ID="PnSenha" runat="server" CssClass="frameModal" Style="display: none"
        ...
        <asp:Label ID="Label15" runat="server" Text="Digite a Senha para Liberação do Desconto"
    ...
    <asp:ModalPopupExtender ID="modalSenha" runat="server" BackgroundCssClass="modalBackground"
        DropShadow="true" PopupControlID="pnSenha" TargetControlID="Label15">
    </asp:ModalPopupExtender>
