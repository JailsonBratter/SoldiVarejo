<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="PedidoVendaDetalhes.aspx.cs"
    MaintainScrollPositionOnPostback="true"
    Inherits="visualSysWeb.modulos.Pedidos.pages.PedidoVendaDetalhes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="cabMenu">
        ...
        <asp:ImageButton ID="imgParametros" runat="server" ImageUrl="~/img/help.png"
                    Height="40px" Visible="false" OnClick="btnParametros_Click" />
    </div>
    ...
    <div id="BtnBaixa" runat="server" class="direitaFechar">
        <asp:ImageButton ID="imgBtnEstorno" runat="server" ImageUrl="~/img/confirm.png" Height="25px"
            OnClick="imgBtnEstorno_Click" />
        Estornar
    </div>
    <div id="cabecalho" runat="server" class="frame">
        <div class="btnImprimirDireita">
            ...
            <div id="divImpressaoSimples" runat="server" class="panelItem">
                <asp:HyperLink ID="linkImpressaoSimples" runat="server" NavigateUrl="~/modulos/Pedidos/pages/PedidoPrint.aspx?simples=true"
                    Target="_blank">
                    <asp:Image ID="Image2" ImageUrl="~/img/icon_imprimir.gif" runat="server" Width="40px" />
                </asp:HyperLink>
                <br />
                Simples
            </div>
            <div class="panelItem">
                <asp:ImageButton ID="btnTitulosAbertos" runat="server" ImageUrl="~/modulos/Financeiro/imgs/Contas.png"
                    Height="40px" Visible="false" OnClick="btnTitulosAbertos_Click" />
            </div>
        </div>
        <table>
            <tr>
                <td>
                    <div class="panelItem">
                        ...
                        <asp:Panel ID="pnSimples" runat="server">
                            <asp:DropDownList ID="ddlPedidoSimples" runat="server" Font-Size="Large" AutoPostBack="true"
                                OnSelectedIndexChanged="ddlPedidoSimples_SelectedIndexChanged">
                                <asp:ListItem Value="0">NAO</asp:ListItem>
                                <asp:ListItem Value="1">SIM</asp:ListItem>
                            </asp:DropDownList>
                            <asp:Label ID="Label14" runat="server" Text="Pedido Simplificado" Font-Size="X-Large"></asp:Label>
                            <asp:Button ID="btnFecharPedido" runat="server" Text="Fechar Pedido" OnClick="btnFecharPedido_Click"
                ...
                <td>
                    ...
                    <div class="panelItem">
                        ...
                        <asp:DropDownList ID="ddlStatus" runat="server">
                            ...
                            <asp:ListItem Value="7">Liberado</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                ...
                <td>
                    ...
                    <div class="panelItem">
                        ...
                        <asp:ImageButton ID="imgBtnCliente" runat="server" ImageUrl="~/img/pesquisaM.png"
                            Height="15px" OnClick="Img_Click" />
                        <asp:ImageButton ID="imgBtnVerificaStatus" runat="server" ImageUrl="~/img/Refresh.png"
                            Height="15px" OnClick="ImgVerifica_Click" Visible="false" />
            ...
            <tr>
                <td>
                    ...
                    <div class="btnImprimirDireita">
                        ...
                        <asp:Panel ID="pnRecuperarPedido" runat="server" Visible="true" CssClass="titulobtn">
                            <asp:ImageButton ID="imgRecupera" runat="server" Height="25px" ImageUrl="~/img/arquivo-download.png"
                                Width="27px" OnClick="imgRecupera_Click" />
                            Rec.Pedido
                        </asp:Panel>
    ...
    <div id="conteudo" runat="server" class="conteudo">
        <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0">
                ...
                <ContentTemplate>
                    ...
                    <asp:Panel ID="addItens" runat="server" CssClass="titulobtn" DefaultButton="ImgBtnAddItens">
                        <div id="divAdditensRapido" runat="server">
                            ...
                            <div class="panelItem">
                                <p>Custo Unit.</p>
                                <asp:TextBox ID="txtCustoAddRapito" runat="server" CssClass="numero" Width="80px" />
                            </div>
                            <div class="panelItem">
                                <p>Mrg</p>
                                <asp:TextBox ID="txtMargemAddRapito" runat="server" CssClass="numero" Width="80px"  OnTextChanged="txtMargemAddRapito_TextChanged" AutoPostBack="true"/>
                            </div>
                            <div class="panelItem">
                                <p>Preço Unit.</p>
                                <asp:TextBox ID="txtPrecoAddRapito" runat="server" CssClass="numero" Width="80px" OnTextChanged="txtPrecoAddRapito_TextChanged" AutoPostBack="true"/>
                            </div>
                            <div class="panelItem">
                                <p>Qtde</p>
                    ...
                    <div class="gridTable">
                        <asp:GridView ID="gridItens" runat="server" ForeColor="#333333" GridLines="Vertical"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="UnitarioDesconto" HeaderText="Preço">
                                    <ItemStyle HorizontalAlign="Right" />
                                </asp:BoundField>
            ...
            <asp:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel4">
                ...
                <ContentTemplate>
                    <asp:TextBox ID="txtHistorico" CssClass="sem" runat="server" Width="800px" Height="200px"
                        TextMode="MultiLine"></asp:TextBox>
                </ContentTemplate>
            </asp:TabPanel>
        </asp:TabContainer>
    ...
    <asp:Panel ID="pnItens" runat="server" CssClass="modalForm" Style="display: none; height: 280px;">
        <asp:Panel ID="pnItensFrame" runat="server" CssClass="frame">
            ...
            <asp:Label ID="lblNumItem" runat="server" Text="" Visible="false"></asp:Label>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txtUnitario" runat="server" CssClass="numero" Width="100px" OnChange="javascript:calculaTotalEditado();"></asp:TextBox>
                    </td>
                    <td>
                        <p>
                            TOTAL :
                ...
                <asp:GridView ID="GridMercadoriaSelecionado" runat="server" CellPadding="4" ForeColor="#333333"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Preço">
                            <ItemTemplate>
                                <asp:TextBox ID="txtPreco" runat="server" Text='<%# Eval("Preco") %>' Width="60px" Enabled="false"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="panelItem">
                            ...
                            <asp:TextBox ID="txtTabPrecoNovo" runat="server" Width="80px"></asp:TextBox>
    ...
    <asp:Panel ID="pnParametors" runat="server" CssClass="modalForm" Style="display: none; height: 280px;">
        <asp:Panel ID="Panel7" runat="server" CssClass="frame">
            <div class="cabMenu">
                <h1>Parametros da tela</h1>
                <asp:Label ID="Label5" runat="server" Text=""></asp:Label>
            </div>
            <table class="cabMenu">
                <tr>
                    <td>
                        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/img/cancel.png" Width="25px"
                            OnClick="ImgBtnCancelaParametros_Click" />
            ...
            <asp:Panel ID="Panel3" runat="server" CssClass="lista">
                <asp:GridView ID="gridParametros" runat="server" CellPadding="4" ForeColor="#333333"
                    GridLines="None" AutoGenerateColumns="false">
                    <Columns>
                        <asp:BoundField DataField="Parametro" HeaderText="Parametro"></asp:BoundField>
                        <asp:BoundField DataField="ValorAtual" HeaderText="Valor Atual"></asp:BoundField>
                        <asp:BoundField DataField="Descritivo" HeaderText="Descritivo"></asp:BoundField>
                    </Columns>
                    <AlternatingRowStyle BackColor="#BEBEBE" ForeColor="#284775" />
                    <EditRowStyle BackColor="#999999" />
                    <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
    ...
    <asp:ModalPopupExtender ID="modalParametros" runat="server" BackgroundCssClass="modalBackground"
        CancelControlID="Label27" DropShadow="true" PopupControlID="pnParametors" TargetControlID="Label27">
    </asp:ModalPopupExtender>

    <!-- Modal para confirmar ou não o fechamento do pedido-->
    <asp:Panel ID="PnFecharPedido" runat="server" CssClass="frameModal" Style="display: none">
        <h3>
            <b>
                <asp:Label ID="Label24" runat="server" Text="Confirma o fechamento do pedido ?"
        ...
        <table>
            <tr>
                <td>
                    <asp:ImageButton ID="imgBtnConfirmaFechar" runat="server" ImageUrl="~/img/confirm.png"
                        Width="25px" OnClick="imgBtnConfirmaFechar_Click" />
                    <asp:Label ID="Label28" runat="server" Text="SIM"></asp:Label>
                </td>
                <td>
                    <asp:ImageButton ID="imgBtnCancelaFechar" runat="server" ImageUrl="~/img/cancel.png"
                        Width="25px" OnClick="imgBtnCancelaFechar_Click" />
                    <asp:Label ID="Label29" runat="server" Text="NÃO"></asp:Label>
                </td>
            </tr>
        </table>
    </asp:Panel>
    <asp:ModalPopupExtender ID="modalFecharPedido" runat="server" BackgroundCssClass="modalBackground"
        DropShadow="true" PopupControlID="PnFecharPedido" TargetControlID="Label24">
    </asp:ModalPopupExtender>
