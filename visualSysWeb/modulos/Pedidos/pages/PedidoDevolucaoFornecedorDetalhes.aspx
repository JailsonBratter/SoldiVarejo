<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PedidoDevolucaoFornecedorDetalhes.aspx.cs" Inherits="visualSysWeb.modulos.Pedidos.pages.PedidoDevolucaoFornecedorDetalhes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="cabMenu">
        <center>
            <h1>
                Detalhes do pedido de devolução Fornecedor</h1>
        </center>
    </div>
        ...
        <table>
            ...
            <tr>
                <td colspan="5">
                    ...
                    <asp:TextBox ID="txtNomeFornecedor" runat="server" Width="400px" AutoPostBack="true"
                        OnTextChanged=" txtFornecedor_TextChanged"></asp:TextBox>
                    <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" Enabled="true"
                        TargetControlID="txtNomeFornecedor" ServiceMethod="GetNomesFornecedor" ServicePath="PedidoDevolucaoFornecedorDetalhes.aspx"
    ...
    <asp:Panel ID="pnMercadoriaLista" runat="server" CssClass="modalForm" Style="display: none;
        ...
        <asp:Panel ID="pnMercadoriaListaFrame" runat="server" CssClass="frameDiv" DefaultButton="imgPesquisaMercadoria"
            ...
            <div class="row" style="font-size: 20px; width: 70%; float: left; margin-left: 20px;">
                ...
                Fornecedor:
                <asp:TextBox ID="txtFornecedorImport" runat="server" Width="80px"></asp:TextBox>
                 <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/img/pesquisaM.png"
                ...
                <asp:GridView ID="GridMercadoriaSelecionado" runat="server" CellPadding="4" ForeColor="#333333"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Emb">
                            <ItemTemplate>
                                <asp:TextBox ID="txtEmbItem" runat="server" Text='<%# Eval("embalagem") %>' Width="30px"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
