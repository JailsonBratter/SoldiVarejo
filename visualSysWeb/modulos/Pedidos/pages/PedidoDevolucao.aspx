<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PedidoDevolucao.aspx.cs" Inherits="visualSysWeb.modulos.Pedidos.pages.PedidoDevolucao" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  <center>
        <h1>
            Pedido de Devolução Cliente</h1>
    </center>
    <hr />
        ...
        <asp:GridView ID="gridPesquisa" runat="server" AutoGenerateColumns="False" CellPadding="5"
            ...
            <Columns>
                <asp:HyperLinkField DataTextField="Pedido" Text="---" Visible="true" HeaderText="Pedido"
                    DataNavigateUrlFormatString="~/modulos/Pedidos/pages/pedidoDevolucaoDetalhes.aspx?campoIndex={0}"
