<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PedidoDevolucaoFornecedor.aspx.cs" Inherits="visualSysWeb.modulos.Pedidos.pages.PedidoDevolucaoFornecedor" %>
...
<center>
        <h1>
            Pedido de Devolução Fornecedor</h1>
    </center>
    <hr />
        ...
        <asp:GridView ID="gridPesquisa" runat="server" AutoGenerateColumns="False" CellPadding="5"
            ...
            <Columns>
                <asp:HyperLinkField DataTextField="Pedido" Text="---" Visible="true" HeaderText="Pedido"
                    DataNavigateUrlFormatString="~/modulos/Pedidos/pages/pedidoDevolucaoFornecedorDetalhes.aspx?campoIndex={0}"
                    DataNavigateUrlFields="pedido" SortExpression="pedido" />
                <asp:HyperLinkField DataTextField="Cliente_Fornec" Text="---" Visible="true" HeaderText="Fornecedor"
                    DataNavigateUrlFormatString="~/modulos/Pedidos/pages/pedidoDevolucaoFornecedorDetalhes.aspx?campoIndex={0}"
                    DataNavigateUrlFields="pedido" SortExpression="Cliente_fornec" />
                <asp:HyperLinkField DataTextField="Razao_social" Text="---" Visible="true" HeaderText="Nome"
                    DataNavigateUrlFormatString="~/modulos/Pedidos/pages/pedidoDevolucaoFornecedorDetalhes.aspx?campoIndex={0}"
