<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PedidoConsolidado.aspx.cs" Inherits="visualSysWeb.modulos.Pedidos.pages.PedidoConsolidado" %>
            ...
            <tr>
                ...
                <td>
                    <asp:Panel ID="pnSimples" runat="server">
                        <p>
                            <asp:Label ID="Label14" runat="server" Text="Pedido Simplificado"></asp:Label></p>
        ...
        <asp:GridView ID="gridPesquisa" runat="server" AutoGenerateColumns="False" CellPadding="5"
            ...
            <Columns>
                <asp:HyperLinkField DataTextField="Pedido" Text="---" Visible="true" HeaderText="Pedido"
                    DataNavigateUrlFormatString="~/modulos/Pedidos/pages/pedidoVendaDetalhes.aspx?campoIndex={0}"
                    DataNavigateUrlFields="pedido" SortExpression="pedido" />
                <asp:HyperLinkField DataTextField="Simples" Text="---" Visible="true" HeaderText="Simples"
                    DataNavigateUrlFormatString="~/modulos/Pedidos/pages/pedidoVendaDetalhes.aspx?campoIndex={0}"
                    DataNavigateUrlFields="pedido" SortExpression="Simples" />
