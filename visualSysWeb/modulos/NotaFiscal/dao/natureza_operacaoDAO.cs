  ...
  public class natureza_operacaoDAO
   {
              ...
              public bool Incide_IPI { get; set; }
         ...
         public natureza_operacaoDAO(String codigoOperacao,User usr){ //colocar campo index da tabela
          ...
          public void carregarDados(SqlDataReader rs){
              try
              {
                  ...
                  if (rs.Read())
                  {
                      ...
                      incide_ST = (rs["incide_ST"].ToString().Equals("1") ? true : false);
        ...
        try{
         ...
         public bool excluir() {  
             String sql = "delete from natureza_operacao  where campoIndex= " ; //colocar campo index
             Conexao.executarSql(sql);
             return true;
         }
