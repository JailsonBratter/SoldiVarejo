<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="NfPedido.aspx.cs" Inherits="visualSysWeb.modulos.NotaFiscal.pages.NfPedido"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <center><h1>EMISSAO DE PEDIDOS</h1></center>
    <hr />
        ...
        <asp:GridView ID="gridPesquisa" runat="server" AutoGenerateColumns="false" CellPadding="5"
            ...
            <Columns>
                <asp:HyperLinkField DataTextField="Codigo" Text="Codigo" Visible="true" HeaderText="Codigo"
                    DataNavigateUrlFormatString="~/modulos/NotaFiscal/pages/NfPedidoDetalhes.aspx?codigo={0}&cliente={1}"
                ...
                <asp:HyperLinkField DataTextField="cliente_fornecedor" Text="cliente_fornecedor"
                    Visible="true" HeaderText="Cod" DataNavigateUrlFormatString="~/modulos/NotaFiscal/pages/NfPedidoDetalhes.aspx?codigo={0}&cliente={1}"
                ...
                <asp:HyperLinkField DataTextField="Total" Text="Total" Visible="true" ItemStyle-HorizontalAlign="Right"
                    HeaderText="Total" DataNavigateUrlFormatString="~/modulos/NotaFiscal/pages/NfPedidoDetalhes.aspx?codigo={0}&cliente={1}"
    ...
    <asp:Panel ID="pnConfirmaEnvioEmail" runat="server" CssClass="frameModal" Style="display: none; height: 180px; width: 500px;">
        <b>
