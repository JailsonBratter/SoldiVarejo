<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SolicitacaoCompra.aspx.cs" Inherits="visualSysWeb.modulos.Estoque.pages.SolicitacaoCompra" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <center><h1>Solicitação Compra</h1></center>
        ...
        <asp:GridView ID="gridPesquisa" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                <asp:HyperLinkField DataTextField="codigo" Text="---" Visible="true" HeaderText="Codigo"
                    DataNavigateUrlFormatString="~/modulos/Estoque/pages/SolicitacaoCompraDetalhes.aspx?codigo={0}"
