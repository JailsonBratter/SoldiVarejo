<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SolicitacaoDeProducao.aspx.cs" Inherits="visualSysWeb.modulos.Estoque.pages.SolicitacaoDeProducao" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
      <center><h1>Solicitação de Produção</h1></center>
        ...
        <asp:GridView ID="gridPesquisa" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                <asp:HyperLinkField DataTextField="codigo" Text="---" Visible="true" HeaderText="Codigo"
                    DataNavigateUrlFormatString="SolicitacaoDeProducaoDetalhes.aspx?codigo={0}"
