<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SolicitacaoDeProducaoDetalhes.aspx.cs" Inherits="visualSysWeb.modulos.Estoque.pages.SolicitacaoDeProducaoDetalhes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="cabMenu">
        <center>
            <h1>
                Solicitação de Produção Detalhes</h1>
        </center>
    </div>
