  ...
  public class Contrato_fornecedor_itemDAO
   {
         ...
         public Contrato_fornecedor_itemDAO(String campoIndex,User usr){ //colocar campo index da tabela
        ...
        try{
         ...
         public bool excluir() {  
             String sql = "delete from Contrato_fornecedor_item  where campoIndex= "+ campoIndex ; //colocar campo index
             Conexao.executarSql(sql);
             return true;
         }
