...
{
  public class Contrato_Fornecedor_FilialDAO
   {
              public String id_contrato ="";
              public String Filial ="";
         public Contrato_Fornecedor_FilialDAO(){ }
         public Contrato_Fornecedor_FilialDAO(String campoIndex,User usr){ //colocar campo index da tabela
             String sql="Select * from  Contrato_Fornecedor_Filial where campoIndex ="+ campoIndex  ;
        ...
        private void update(){
        try{
         String sql= "update  Contrato_Fornecedor_Filial set "+
         ...
         public bool excluir() {  
             String sql = "delete from Contrato_Fornecedor_Filial  where campoIndex= "+ campoIndex ; //colocar campo index
             Conexao.executarSql(sql);
             return true;
         }
     ...
     private void insert(){
         try{
             String sql = " insert into Contrato_Fornecedor_Filial " (+
                       "id_contrato"+
                       ",Filial"+
                  " )values( "+
                       "'"+id_contrato+"'"+
...
{ 
                  static DataTable tb;
                  static String sqlGrid = ""select * from Contrato_Fornecedor_Filial";//colocar os campos no select que ser?o apresentados na tela
                  ...
                  {
                      Response.Redirect("~/modulos/nome Do Modulo/pages/ Contrato_Fornecedor_FilialDetalhes.aspx?novo=true"); // colocar caminho da pagina de Detalhes verificar Case sensitive
                  }
...
/*================================html tela de Pesquisa==========================================
   ...
   <center><h1>Contrato_Fornecedor_Filial</h1></center>
    <hr />              
        ...
        <div class="gridTable">          
            <asp:GridView ID="gridPesquisa" runat="server" AutoGenerateColumns="False"           
                 ...
                 <Columns> 
                    ...
                    HeaderText="id_contrato" DataNavigateUrlFormatString="~/modulos/Coloca Nome Do Modulo/Contrato_Fornecedor_FilialDetalhes.aspx?campoIndex={0}" 
                    ...
                    HeaderText="Filial" DataNavigateUrlFormatString="~/modulos/Coloca Nome Do Modulo/Contrato_Fornecedor_FilialDetalhes.aspx?campoIndex={0}" 
                        DataNavigateUrlFields="//colocar o campo Index que fara a pesquisar" />  
...
using System.Data.SqlClient;
  ...
  {
                 protected static Contrato_Fornecedor_FilialDAO obj= null ;
                 static String camporeceber = "";
                 protected void Page_Load(object sender, EventArgs e)     
                 {
                      User usr = (User)Session["User"];
                      obj = new Contrato_Fornecedor_FilialDAO();
                           ...
                           if (Request.Params["campoIndex"] != null)  // colocar o campo index da tabela
                           {
                              try
                              {
                                   if (!IsPostBack)
                                   {
                                        ...
                                        status = "visualizar";
                                        obj = new Contrato_Fornecedor_FilialDAO(index,usr);
                                        carregarDados();
                                    }
...
<div class="cabMenu">                  
       <center> <h1>Detalhes do Contrato_Fornecedor_Filial</h1></center>                  
</div>                  
    <asp:Panel ID="pnBtn" runat="server" CssClass="cabMenu">                  
    </asp:Panel>                  
    <br />              
