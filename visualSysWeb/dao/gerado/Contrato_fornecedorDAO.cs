  ...
  public class Contrato_fornecedorDAO
   {
         ...
         public Contrato_fornecedorDAO(String campoIndex,User usr){ //colocar campo index da tabela
             String sql="Select * from  Contrato_fornecedor where campoIndex ="+ campoIndex  ;
        ...
        try{
         ...
         public bool excluir() {  
             String sql = "delete from Contrato_fornecedor  where campoIndex= "+ campoIndex ; //colocar campo index
             Conexao.executarSql(sql);
             return true;
         }
